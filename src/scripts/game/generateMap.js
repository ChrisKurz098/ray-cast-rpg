function createArray(num, dimensions) {
  ...
  function createMap(dimensions, maxTunnels, maxLength) {
     ...
     let currentRow = initX // our current row - start at a random spot
     let currentColumn = initY // our current column - start at a random spot
    ...
    map.push(hor);
    map.unshift(hor);
    return {map,initX,initY}; // all our tunnels have been created and our map is complete, so lets return it to our render()
  };
